...
@section('content')
    <div class="container-fluid py-4">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h2 class="fw-bold m-0">Create Role</h2>
        ...
        <form action="{{ route('admin.roles.store') }}" method="POST">
            ...
            <div class="card border-0 shadow-sm rounded-4 mb-4">
                <div class="card-body p-4">
                    <div class="mb-3">
                        ...
                        <input type="text" name="name" class="form-control bg-light border-0 rounded-pill px-3" required
            ...
            <button type="submit" class="btn btn-primary rounded-pill px-5 fw-bold">Create Role</button>
        </form>
    </div>
@endsection