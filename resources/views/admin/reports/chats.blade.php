...
@section('title', 'Human Chat Sessions Report')

@section('content')
    <div class="container-fluid py-4">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h2 class="fw-bold m-0">Human Chat Sessions</h2>
            <div>
                <a href="{{ route('admin.reports.chats', array_merge(request()->all(), ['export' => 1])) }}"
                    ...
                    <tbody>
                        @foreach($sessions as $session)
                            <tr>
                                ...
                                <td>{{ $session->total_messages_user }}</td>
                                ...
                                <td>
                                    <span
                                        class="badge bg-{{ $session->status == 'active' ? 'primary' : 'success' }}-subtle text-{{ $session->status == 'active' ? 'primary' : 'success' }} rounded-pill px-3">
